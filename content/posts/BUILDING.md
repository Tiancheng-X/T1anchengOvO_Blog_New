# 制作思路：Quick Resolution Switch

> 一个托盘分辨率切换器的完整开发复盘 —— 从 wayfinder 地图到 540KB 单文件 exe，以及过程中踩过的所有坑。
...
4. **wayfinder 的价值**：决策先写进工单再动手，回头复盘时每个选择都有据可查

---

*项目源码与构建方式见 README.md。*
